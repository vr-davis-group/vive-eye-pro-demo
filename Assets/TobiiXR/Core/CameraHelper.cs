...
namespace Tobii.XR
{
    public class CameraHelper : ICameraHelper
    {
        ...
        {
            if (_cachedCamera == null) _cachedCamera = Internal_GetMainCamera();
        ...
        {
            get { return GetCameraTransform().forward; }
        }
        ...
        private static Camera Internal_GetMainCamera()
        {
            ...
            Debug.LogError("No camera found in scene. Add a camera before running TobiiXR.");
            return null;
        }
    }
