...
public class G2OMVisualisation : MonoBehaviour
{
    [SerializeField]
    ...
    IEnumerator OnPostRender()
    {
        ...
        // Render again at end of frame to show up on screen.
    ...
    private Color GetResultColor(G2OM_CandidateResult[] g2OmCandidatesResult, int id)
    {
        var score = 0f;
        var isFirst = false;
