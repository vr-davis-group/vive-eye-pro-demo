...
/// Tested with SR Anipal version 1.0.1
/// </summary>
...
public class HTCProvider : IEyeTrackingProvider
{
    ...
    public void Tick()
    {
        ...
        var matrix = _hmdToWorldTransformer.GetTransformMatrixFrom(10);
        EyeTrackingDataHelper.TransformGazeData(EyeTrackingData, matrix);
#endif
    }
